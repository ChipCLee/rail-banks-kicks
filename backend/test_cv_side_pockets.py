...
class TestCVSidePocketOrientation(unittest.TestCase):
    ...
    def test_example_portrait_detection(self):
        ...
        # example.jpg has long rails vertical at left/right -> is_portrait should be True
        self.assertTrue(is_portrait, "example.jpg should be identified as portrait (is_portrait=True)")
