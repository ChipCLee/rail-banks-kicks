...
class TestCVSidePocketOrientation(unittest.TestCase):
    ...
    def test_example_1_portrait_detection(self):
        ...
        # example_1.jpg is a portrait camera upload -> is_portrait must be True
        self.assertTrue(is_portrait, "example_1.jpg should be identified as portrait (is_portrait=True)")
